...
local massachusetts			= 1 // **KP: need to crosswalk zipcode to county for data before 2021m7; need to do more work making variables consistent for tanf across different sources
local michigan				= 0
local minnesota				= 0 
local mississippi			= 0 
local missouri				= 0 
