...
// apps part - county level (005) - would need to rework code below

// apps part - state level (007)
...
**THIS CODE IS OLDER, AND WOULD NEED TO BE MODIFIED TO GET COUNTY-LEVEL APPLICATIONS DATA **
/*
