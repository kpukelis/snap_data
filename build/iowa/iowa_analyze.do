...
local beginning_clock1 			= ym(2017,11) - 0.5
...
label var _totalrecipients "SNAP persons"
label var _totalallotments "SNAP issuance"
label var _overallaverageperhousehold "SNAP average issuance per case"
label var _overallaverageperrecipient "SNAP average issuance per recipient"


foreach outcome in _totalhouseholds _totalrecipients _totalallotments _overallaverageperhousehold _overallaverageperrecipient {
...
foreach outcome in snap_households snap_persons snap_adults snap_children {
	...
	histogram perc, ///
		...
		ytitle(`"Counties"') ///
		title(`"iowa: percentage dropped between 2013m12-2014m1 by county"') ///
