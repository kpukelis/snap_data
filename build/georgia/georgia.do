...
if !inlist(`year',2013,2014) {
	...
	// import 
	import excel using "${dir_root}/data/state_data/georgia/excel/state/Desc Data_`year'.xlsx", allstring case(lower) clear
...
// save 
save "${dir_root}/data/state_data/georgia/georgia.dta", replace 
